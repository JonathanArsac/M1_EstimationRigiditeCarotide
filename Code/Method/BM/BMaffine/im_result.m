...
true_lat=readimg('D_x6.img',160,160);
true_ax=readimg('D_y6.img',160,160);
...
figure;
subplot(2,2,1);
imagesc(champ_dep_est(:,:,1,1).*pixel_x)
...
figure;
subplot(2,2,1);
imagesc(champ_dep_est(:,:,1,2).*pixel_y)
...
% close all
% save realite_terrain2 true_axial true_lateral
