...
load RF-image-heart1-TO-odd
im(:,:,1) = rf_image(1:decim_y:end,1:decim_x:end);

load RF-image-heart2-TO-odd
im(:,:,2) = rf_image(1:decim_y:end,1:decim_x:end);
...
%     fy   fx
f = [0.06 0.05].*[decim_y decim_x];

% pixel size in mm
pixel_size_ax = 0.015*decim_y;
pixel_size_lat = 0.467*decim_x; %Pour l'echographe Ultrasonix taille pixel 40 mm (taille sonde) /128 lignes = 0.3125 mm
...
Z_im=[ 2500/decim_y  6500/decim_y ;   50/decim_x  250/decim_x ];
